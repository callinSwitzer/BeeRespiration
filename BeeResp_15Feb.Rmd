...
newDF <- within(newDF, {dmr_apl = deltaMetR / deltaPercLoad})
...
```{r}
newDF <- within(newDF, {df2_apl = deltaFrq2 / deltaPercLoad})
par(mfrow = c(1,1))
...
```{r}
newDF <- within(newDF, {da2_apl = deltaArcL2 / deltaPercLoad})
